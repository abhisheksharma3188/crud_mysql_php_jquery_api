...
<html>
    ...
    <body>
        <div style="margin-right:auto;margin-left:auto;width:500px;text-align:center;">
            <form id="update_form">
                <h3>Update Data</h3>   
                <input type="number" name="s_no_input" placeholder="S.No to update" required><br><br> 
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.response == 'success') {
                            document.getElementById('response_div').innerHTML=`Message - ${data.message}. Data at serial number - ${data.s_no} updated successfully.`;
                        }
